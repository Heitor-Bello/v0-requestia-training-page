...
export function EnrollFormAdvanced({
  ...
  return (
    <div className="md:col-span-2 border rounded-2xl shadow-lg shadow-[#004680]/10 flex flex-col sm:h-[680px]">
      {/* Header */}
      <div className="p-6">
      ...
      {/* Form Content - no scroll on mobile, scroll on desktop */}
      <div className="flex-1 sm:overflow-y-auto sm:no-scrollbar p-6">
