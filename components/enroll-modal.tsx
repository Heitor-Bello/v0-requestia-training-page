    ...
    switch (level) {
      case "essentials":
        return {
          ...
          description:
            "Conheça os conceitos fundamentais da administração e as principais funcionalidades da plataforma.",
          tInfo1: "Plataforma",
          ...
          targetAudience:
            "Usuários que irão administrar a Plataforma Requestia ou que precisam entender seu funcionamento básico.",
          mainBenefit:
            "Compreenda a estrutura da plataforma, realize configurações iniciais com mais segurança e prepare-se para avançar na trilha de capacitação.",
      ...
      case "foundations":
        return {
          ...
          tInfo1: "Data",
          rInfo1: foundationSession.date,
          tInfo2: "Local",
          access: foundationSession.location,
          tInfo3: "Duração",
          hours: foundationSession.duration,
          certification: "Requestia Foundation",
          targetAudience:
            "Profissionais que precisam administrar a plataforma no dia a dia, com mais autonomia e segurança.",
          mainBenefit:
            "Evolua processos existentes e ganhe mais segurança para sustentar e expandir o uso da Requestia na operação.",
          prerequisite:
            "Conclusão do Requestia Essentials ou conhecimento equivalente.",
          content: [
      ...
      default:
        return {
          ...
          targetAudience:
            "Profissionais que precisam atuar com recursos avançados da plataforma em cenários mais complexos.",
          mainBenefit:
            "Atue com mais autonomia em cenários técnicos avançados, amplie as possibilidades de uso e fortaleça a evolução dos processos da empresa.",
        ...
        <div className="p-6">
          ...
          <div className="border p-4 rounded-md">
            <div className="mb-8 border-b pb-5">
              <Badge
                className={`${data.levelColor} text-white border-0 px-3 py-1 rounded-full mb-4`}
              >
                {data.levelBadge}
              </Badge>
              <h2 className="text-2xl font-semibold text-[#00233f] mb-2">
                {data.title}
              </h2>
              <p className="text-sm font-regular text-[#5F7990]">
                {data.description}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-6">
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[#5F7990] font-normal">
                    {data.tInfo1}
                  </span>
                </div>
                <span className="text-sm font-medium text-gray-800 ml-7">
                  {data.rInfo1}
                </span>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-[#5F7990] font-normal">
                    {data.tInfo2}
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 mt-5 items-start">
            ...
            <div className="space-y-6">
              <div className="border p-4 rounded-md">
                <h3 className="text-base font-semibold text-[#003765] border-b pb-3 mb-6">
                ...
                <div className="mb-6">
                  <div className="flex items-start gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#5F7990] mt-1">
                        {data.targetAudience}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-6">
                  <div className="flex items-start gap-3 mb-2">
                    <CheckCircle2 className="w-5 h-5 text-[#5F7990] shrink-0 mt-0.5" />
                    <div>
                      <p className="font-medium text-[#5F7990]">
                        Benefício principal:
                      </p>
                      <p className="text-xs text-[#5F7990] mt-1">
                        {data.mainBenefit}
                ...
                <div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-[#5F7990] mb-2">
                        Conteúdo
                      </p>
              ...
              {(level === "foundations" || level === "expert") && (
                <div className="p-4 rounded-md">
                  <h3 className="text-base font-semibold text-[#003765] mb-4 border-b pb-4">
                    Investimento
                  </h3>
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-[#5F7990]">
                      <span className="font-normal">3 pessoas:</span> R$
                      1.000,00
                    </div>
                  </div>
                </div>
