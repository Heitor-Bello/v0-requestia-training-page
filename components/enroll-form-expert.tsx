...
export function EnrollFormExpert({ formData, onFormDataChange, onSubmit, isSubmitting = false }: EnrollFormExpertProps) {
  ...
  const [formParticipant, setFormParticipant] = useState<Omit<AdditionalParticipant, 'id'>>({
    addName: '',
    company: '',
    role: '',
    email: '',
  ...
  const handleSaveParticipant = () => {
    if (editingParticipantId) {
      ...
      setAdditionalParticipants(prev => [...prev, newParticipant])
    }
  ...
  return (
    <div className="md:col-span-2 border rounded-2xl shadow-lg shadow-[#004680]/10 flex flex-col h-[680px]">
      {/* Header */}
      <div className="p-6">
        <h3 className="text-2xl font-normal text-[#00233f]">Dados para inscrição</h3>
      </div>
          ...
          <div className="mb-6 border-b pb-4">
            ...
            {isParticipantDataExpanded && (
              <div className="mt-4 space-y-4">
                ...
                <p className="text-sm font-semibold text-[#212121]">Necessidades Especiais (PCD)*</p>
                <p className="text-xs font-normal text-[#787979] -mt-2">Para proporcionarmos uma experiência inclusiva, informe se você ou algum participante é uma Pessoa com Deficiência (PCD) e se há alguma necessidade especial para participação no treinamento.</p>
              ...
              <div className="mt-4 space-y-4">
                ...
                {!isAddingParticipant && remainingSlots > 0 ? (
                  ...
                  <div className="border rounded-lg p-4 space-y-4">
                    <h5 className="font-semibold text-[#00233f]">Participante adicional {additionalParticipants.length + 1}</h5>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <input
                        ...
                        onChange={(e) => setFormParticipant({ ...formParticipant, addName: e.target.value })}
                      ...
                      <input
                        ...
                        onChange={(e) => setFormParticipant({ ...formParticipant, role: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#0D5B9C]"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormParticipant({ ...formParticipant, phone: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#0D5B9C]"
                      />
                    </div>
                      ...
                      <div className="flex items-center gap-8 mt-2">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            onChange={() => setFormParticipant({ ...formParticipant, isPCD: true })}
                            className="w-4 h-4 cursor-pointer"
                          />
                          <span className="text-sm text-[#212121]">Sim, sou PCD e preciso de acomodações.</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            onChange={() => setFormParticipant({ ...formParticipant, isPCD: false })}
                            className="w-4 h-4 cursor-pointer"
                          />
                          <span className="text-sm text-[#212121]">Não</span>
                        </label>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormParticipant({ ...formParticipant, pcdDescription: e.target.value })}
